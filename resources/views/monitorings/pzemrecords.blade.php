    ...
    <div class="row">
        <div class="col">
            <div class="list-group">
                {!! Form::open(['action' => 'App\Http\Controllers\MonitoringsController@getpzemrecords', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                <div class="card">
                    <div class="card-header">
                      PZEM_sn : {{$pzem->pzem_sn}}
                    </div>
                    <div class="card-body">
                        <form>
                            ...
                            <div class="col-sm-10">
                                ...
                                <input id="pzemid" type="hidden" name="pzemid" value="{{$pzem->id}}" />
                            </div>
                            </fieldset>
